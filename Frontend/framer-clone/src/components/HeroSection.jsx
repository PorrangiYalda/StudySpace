...
import studyImage from "../assets/studyspace.png"; // Replace with your image path

export default function HeroSection() {
  return (
    <div className="min-h-screen bg-white font-sans text-black">
      <header className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
        <h1 className="text-xl font-bold bg-pink-100 px-2 py-1 rounded-full">StudySpace</h1>
      ...
      <main className="grid md:grid-cols-2 gap-8 p-10 items-center">
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            <button className="bg-black text-white px-5 py-2 rounded-full font-semibold">Try Now</button>
            <button className="border border-black px-5 py-2 rounded-full font-semibold">Learn More</button>
          </div>
          <div className="flex items-center gap-2 text-sm text-gray-600">
            <IoLocationOutline />
        ...
        <div className="relative">
          <img 
            ...
            className="rounded-3xl border-8 border-pink-300 rotate-2 shadow-lg w-full max-w-sm mx-auto" 
          />
        </div>
      </main>
    </div>
